...
abstract class ProductListState extends Equatable {
  ...
  @override
  List<Object> get props => [products ?? [], exception ?? DioException(requestOptions: RequestOptions(data: []))];
}
...
class ProductListLoadedState extends ProductListState {
  const ProductListLoadedState(List<ProductsListModel> products) : super(products: products);
}

class ProductListErrorState extends ProductListState {
  const ProductListErrorState(ApiException exception) : super(exception: exception);
}
