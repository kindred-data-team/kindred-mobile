...
import 'package:kindred_app/features/doctor/products/data/repository/product_repository.dart';
...
class ProductListBloc extends Bloc<ProductListEvent, ProductListState> {
  ...
  void onGetProductList(
    ...
    final dataState =
        await sampleProductRepository.getProductList(event.limit, event.skip);
